...
import com.mzcovid19project.Adapter.CoronaAdapter;
import com.mzcovid19project.Adapter.FAQAdapter;
import com.mzcovid19project.Models.Corona;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Rajasthan").getJSONObject("districtData");
