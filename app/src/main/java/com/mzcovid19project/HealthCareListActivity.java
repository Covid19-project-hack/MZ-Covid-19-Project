...
import com.mzcovid19project.Adapter.HealthCareListAdapter;
import com.mzcovid19project.Models.HealthCareList;
...
public class HealthCareListActivity extends AppCompatActivity implements HealthCareListAdapter.SearchAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHealthCareDatabase = FirebaseDatabase.getInstance().getReference().child("health_care").child(type);
